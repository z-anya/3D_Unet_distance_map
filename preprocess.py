    ...
    def fix_data(self):
        ...
        for ct_file, i in zip(file_list, range(Numbers)):
            ...
            if new_ct != None and new_labels !=None:
                ...
                sitk.WriteImage(new_labels, os.path.join(self.fixed_path, 'labels', ct_file.replace('.nii', '.nii.gz')))
...
if __name__ == '__main__':
    raw_dataset_path = '/opt/data/private/DATA'
    fixed_dataset_path = '/opt/data/private/3DUNet-distancemap/dataset/fixed_data'
